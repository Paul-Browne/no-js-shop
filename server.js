    ...
    ${Object.keys(productsByName).map((product, index) => {
        ...
        const descs = potentialCombos.map((el, ind) => {
            ...
            <div class="details storage color storage-${selectableIndex} color-${colorIndex}">
                <img src="https://static.shop.paulbrowne.dev/images/height-350px/${prod.url}-${prod.color}.jpg" ${index > 5 ? `loading="lazy"` : ""} alt="${prod.name} ${prod.color}">
            ...
            <div class="details storage color storage-${selectableIndex} color-${colorIndex} unavailable">
                <img src="https://static.shop.paulbrowne.dev/images/height-350px/${product}-${el[1]}.jpg" ${index > 5 ? `loading="lazy"` : ""} alt="${productsArray[0].name} ${el[1]} unavailable">
